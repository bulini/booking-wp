...
<div class="post">
	<div class="post-thumbnail">
		<a href="<?php the_permalink(); ?>"><?php the_post_thumbnail('slider-single', array('class'=>'img-responsive')); ?></a>
	</div>
	<div class="post-content">
		<header class="post-header">
				<h2 class="pull-left title"><a href="<?php the_permalink(); ?>"><?php the_title();?></a></h2>
