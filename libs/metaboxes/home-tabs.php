...
add_filter( 'cmb_meta_boxes', 'cmb_tabs_metaboxes' );
/**
 ...
 * @return array
 */
function cmb_tabs_metaboxes( array $meta_boxes ) {
...
add_action( 'init', 'cmb_initialize_tabs_meta_boxes', 9999 );
/**
 * Initialize the metabox class.
 */
function cmb_initialize_tabs_meta_boxes() {
