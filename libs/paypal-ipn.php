...
function Ipn() {
  if ( ! empty( $_GET['ipn-payment'] ) && current_user_can( 'manage_options' ) ) {
    ...
    if (strcmp ($res, "VERIFIED") == 0) {
    	...
    	$result['item_name'] = $_POST['item_name'];
    	$result['item_number'] = $_POST['item_number'];
    	$result['payment_status'] = $_POST['payment_status'];
    	$result['payment_amount'] = $_POST['mc_gross'];
    	$result['payment_currency'] = $_POST['mc_currency'];
    	$result['txn_id'] = $_POST['txn_id'];
